$(document).ready(function() {
    initialize();
     $('#medicines_priv').on('change', function () {
         var key0 = '#A5A5A5';
         var key1 = '#c9b9a2';
         var key2 = '#93a76e';
         var key3 = '#5AFCBB';
        ...
        if (this.value == 'M01') {  
            ...
            $('li.c04').delay(40).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c08').delay(80).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c02').html('<i style="color:#000">Egypt</i>');
            $('li.c03').html('<i>Ethiopia</i>');
            $('li.c04').html('<i>Ghana</i>');
            $('li.c05').html('<i style="color:#000">Kenya</i>');
            $('li.c06').html('<i style="color:#000">Mauritius</i>');
            $('li.c07').html('<i style="color:#000">Morocco</i>');
            $('li.c08').html('<i style="color:#000">Nigeria</i>');
            $('li.c09').html('<i style="color:#000">South Africa, Gauteng Province</i>');
            $('li.c10').html('<i style="color:#000">Sudan</i>');
            $('li.c11').html('<i style="color:#000">Tanzania</i>');
            $('li.c12').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Amitriptyline<br><i>Chad</i><br><strong>7 days</strong></span>');
            $('div.tp02').html('<span>Amitriptyline<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Amitriptyline<br><i>Ethiopia</i><br><strong>3 days</strong></span>');
            $('div.tp04').html('<span>Amitriptyline<br><i>Ghana</i><br><strong>3 days</strong></span>');
            $('div.tp05').html('<span>Amitriptyline<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Amitriptyline<br><i>Mauritius</i><br><strong>1 day</strong></span>');
            $('div.tp07').html('<span>Amitriptyline<br><i>Morocco</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Amitriptyline<br><i>Nigeria</i><br><strong>2 days</strong></span>');
            $('div.tp09').html('<span>Amitriptyline<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Amitriptyline<br><i>Sudan</i><br><strong>2 days</strong></span>');
            $('div.tp11').html('<span>Amitriptyline<br><i>Tanzania</i><br><strong>1 day</strong></span>');
            $('div.tp12').html('<span>Amitriptyline<br><i>Uganda</i><br><strong>1 day</strong></span>');
        } 
            ...
            $('li.c02').delay(20).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c11').delay(110).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Burundi</i>');
            $('li.c03').html('<i style="color:#000">Cameroon</i>');
            $('li.c04').html('<i style="color:#000">Congo</i>');
            $('li.c05').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c06').html('<i style="color:#000">Ethiopia</i>');
            $('li.c07').html('<i style="color:#000">Mali</i>');
            $('li.c08').html('<i style="color:#000">Mauritius</i>');
            $('li.c09').html('<i style="color:#000">Morocco</i>');
            $('li.c10').html('<i style="color:#000">Nigeria</i>');
            $('li.c11').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c12').html('<i style="color:#000">Sudan</i>');
            $('li.c13').html('<i style="color:#000">Tunisia</i>');

            $('div.tp01').html('<span>Amoxicillin<br><i>Burkina Faso</i><br><strong>1 day</strong></span>');
            $('div.tp02').html('<span>Amoxicillin<br><i>Burundi</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Amoxicillin<br><i>Cameroon</i><br><strong>2 days</strong></span>');
            $('div.tp04').html('<span>Amoxicillin<br><i>Congo</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Amoxicillin<br><i>Democratic Republic of Congo</i><br><strong>1 day</strong></span>');
            $('div.tp06').html('<span>Amoxicillin<br><i>Ethiopia</i><br><strong>1 day</strong></span>');
            $('div.tp07').html('<span>Amoxicillin<br><i>Mali</i><br><strong>2 days</strong></span>');
            $('div.tp08').html('<span>Amoxicillin<br><i>Mauritius</i><br><strong>1 day</strong></span>');
            $('div.tp09').html('<span>Amoxicillin<br><i>Morocco</i><br><strong>1 day</strong></span>');
            $('div.tp10').html('<span>Amoxicillin<br><i>Nigeria</i><br><strong>1 day</strong></span>');
            $('div.tp11').html('<span>Amoxicillin<br><i>São Tomé and Príncipe</i><br><strong>2 days</strong></span>');
            $('div.tp12').html('<span>Amoxicillin<br><i>Sudan</i><br><strong>1 day</strong></span>');
            $('div.tp13').html('<span>Amoxicillin<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
        }
        else if (this.value == 'M03') {  
            animateGrid();configurate_M3();
            $('object.graphic').attr('data','svg/Atenolol.svg');

            $('li.c01').delay(0).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c02').delay(20).velocity({backgroundColor: key10}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key5}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c03').html('<i style="color:#000;">Egypt</i>');
            $('li.c04').html('<i style="color:#000;">Ghana</i>');
            $('li.c05').html('<i style="color:#000;">Kenya</i>');
            $('li.c06').html('<i style="color:#000;">Mauritius</i>');
            $('li.c07').html('<i style="color:#000;">Nigeria</i>');
            $('li.c08').html('<i>São Tomé and Príncipe</i>');
            $('li.c09').html('<i style="color:#000;">South Africa, Gauteng Province</i>');
            $('li.c10').html('<i style="color:#000;">Sudan</i>');
            $('li.c11').html('<i style="color:#000;">Tanzania</i>');
            $('li.c12').html('<i style="color:#000;">Tunisia</i>');

            $('div.tp01').html('<span>Atenolol<br><i>Burkina Faso</i><br><strong>2 days</strong></span>');
            $('div.tp02').html('<span>Atenolol<br><i>Democratic Republic of Congo</i><br><strong>10 days</strong></span>');
            $('div.tp03').html('<span>Atenolol<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Atenolol<br><i>Ghana</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Atenolol<br><i>Kenya</i><br><strong>1 day</strong></span>');
            $('div.tp06').html('<span>Atenolol<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Atenolol<br><i>Nigeria</i><br><strong>1 day</strong></span>');
            $('div.tp08').html('<span>Atenolol<br><i>São Tomé and Príncipe</i><br><strong>5 days</strong></span>');
            $('div.tp09').html('<span>Atenolol<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Atenolol<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Atenolol<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Atenolol<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
        }
        else if (this.value == 'M04') {  
            animateGrid();configurate_M4();
            $('object.graphic').attr('data','svg/Captopril.svg');

            $('li.c01').delay(0).velocity({backgroundColor: key5}, { duration: 100 }, "easeOutSine");
            $('li.c02').delay(20).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({backgroundColor: key10}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c06').delay(60).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key10}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c15').delay(150).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c17').delay(170).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c18').delay(180).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c19').delay(190).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Congo</i>');
            $('li.c03').html('<i>Democratic Republic of Congo</i>');
            $('li.c04').html('<i style="color:#000" >Egypt</i>');
            $('li.c05').html('<i>Ghana</i>');
            $('li.c06').html('<i style="color:#000">Kenya</i>');
            $('li.c07').html('<i>Mali</i>');
            $('li.c08').html('<i style="color:#000">Mauritius</i>');
            $('li.c09').html('<i style="color:#000">Morocco</i>');
            $('li.c10').html('<i style="color:#000">Nigeria</i>');
            $('li.c11').html('<i>São Tomé and Príncipe</i>');
            $('li.c12').html('<i style="color:#000">South Africa, Gauteng Province</i>');
            $('li.c13').html('<i style="color:#000">Sudan</i>');
            $('li.c14').html('<i style="color:#000">Tanzania</i>');
            $('li.c15').html('<i style="color:#000">Tunisia</i>');

            $('div.tp01').html('<span>Captopril<br><i>Burkina Faso</i><br><strong>5 days</strong></span>');
            $('div.tp02').html('<span>Captopril<br><i>Congo</i><br><strong>4 days</strong></span>');
            $('div.tp03').html('<span>Captopril<br><i>Democratic Republic of Congo</i><br><strong>10 days</strong></span>');
            $('div.tp04').html('<span>Captopril<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Captopril<br><i>Ghana</i><br><strong>8 days</strong></span>');
            $('div.tp06').html('<span>Captopril<br><i>Kenya</i><br><strong>4 days</strong></span>');
            $('div.tp07').html('<span>Captopril<br><i>Mali</i><br><strong>6 days</strong></span>');
            $('div.tp08').html('<span>Captopril<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Captopril<br><i>Morocco</i><br><strong>3 days</strong></span>');
            $('div.tp10').html('<span>Captopril<br><i>Nigeria</i><br><strong>4 days</strong></span>');
            $('div.tp11').html('<span>Captopril<br><i>São Tomé and Príncipe</i><br><strong>10 days</strong></span>');
            $('div.tp12').html('<span>Captopril<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp13').html('<span>Captopril<br><i>Sudan</i><br><strong>3 days</strong></span>');
            $('div.tp14').html('<span>Captopril<br><i>Tanzania</i><br><strong>1 day</strong></span>');
            $('div.tp15').html('<span>Captopril<br><i>Tunisia</i><br><strong>2 days</strong></span>');
        }
            ...
            $('li.c03').delay(30).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key5}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c11').delay(110).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c04').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c05').html('<i>Ghana</i>');
            ...
            $('li.c13').html('<i style="color:#000">Tanzania</i>');
            $('li.c14').html('<i style="color:#000">Tunisia</i>');
            $('li.c15').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Ceftriaxone<br><i>Burkina Faso</i><br><strong>1 day</strong></span>');
            $('div.tp02').html('<span>Ceftriaxone<br><i>Cameroon</i><br><strong>7 days</strong></span>');
            $('div.tp03').html('<span>Ceftriaxone<br><i>Congo</i><br><strong>2 days</strong></span>');
            $('div.tp04').html('<span>Ceftriaxone<br><i>Democratic Republic of Congo</i><br><strong>3 days</strong></span>');
            $('div.tp05').html('<span>Ceftriaxone<br><i>Ghana</i><br><strong>5 days</strong></span>');
            $('div.tp06').html('<span>Ceftriaxone<br><i>Kenya</i><br><strong>2 days</strong></span>');
            $('div.tp07').html('<span>Ceftriaxone<br><i>Mali</i><br><strong>7 days</strong></span>');
            $('div.tp08').html('<span>Ceftriaxone<br><i>Mauritius</i><br><strong>1 day</strong></span>');
            $('div.tp09').html('<span>Ceftriaxone<br><i>Morocco</i><br><strong>3 days</strong></span>');
            $('div.tp10').html('<span>Ceftriaxone<br><i>Nigeria</i><br><strong>7 days</strong></span>');
            $('div.tp11').html('<span>Ceftriaxone<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Ceftriaxone<br><i>Sudan</i><br><strong>4 days</strong></span>');
            $('div.tp13').html('<span>Ceftriaxone<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp14').html('<span>Ceftriaxone<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp15').html('<span>Ceftriaxone<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        } 
            ...
            $('li.c01').delay(0).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c02').delay(20).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key5}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({backgroundColor: key30}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c15').delay(150).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c17').delay(170).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c18').delay(180).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c19').delay(190).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c20').delay(200).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");            
            ...
            $('li.c05').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c06').html('<i style="color:#000">Ethiopia</i>');
            $('li.c07').html('<i style="color:#000">Ghana</i>');
            $('li.c08').html('<i style="color:#000">Kenya</i>');
            $('li.c09').html('<i>Mali</i>');
            $('li.c10').html('<i style="color:#000">Mauritius</i>');
            $('li.c11').html('<i>Morocco</i>');
            $('li.c12').html('<i style="color:#000">Nigeria</i>');
            $('li.c13').html('<i>São Tomé and Príncipe</i>');
            $('li.c14').html('<i style="color:#000">South Africa, Gauteng Province</i>');
            $('li.c15').html('<i style="color:#000">Sudan</i>');
            $('li.c16').html('<i style="color:#000">Tanzania</i>');
            $('li.c17').html('<i>Tunisia</i>');
            $('li.c18').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Ciprofloxacin<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Ciprofloxacin<br><i>Burundi</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Ciprofloxacin<br><i>Cameroon</i><br><strong>6 days</strong></span>');
            $('div.tp04').html('<span>Ciprofloxacin<br><i>Congo</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Ciprofloxacin<br><i>Democratic Republic of Congo</i><br><strong>1 day</strong></span>');
            $('div.tp06').html('<span>Ciprofloxacin<br><i>Ethiopia</i><br><strong>1 day</strong></span>');
            $('div.tp07').html('<span>Ciprofloxacin<br><i>Ghana</i><br><strong>3 days</strong></span>');
            $('div.tp08').html('<span>Ciprofloxacin<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Ciprofloxacin<br><i>Mali</i><br><strong>4 days</strong></span>');
            $('div.tp10').html('<span>Ciprofloxacin<br><i>Mauritius</i><br><strong>1 day</strong></span>');
            $('div.tp11').html('<span>Ciprofloxacin<br><i>Morocco</i><br><strong>5 days</strong></span>');
            $('div.tp12').html('<span>Ciprofloxacin<br><i>Nigeria</i><br><strong>38 days</strong></span>');
            $('div.tp13').html('<span>Ciprofloxacin<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp14').html('<span>Ciprofloxacin<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp15').html('<span>Ciprofloxacin<br><i>Sudan</i><br><strong>1 day</strong></span>');
            $('div.tp16').html('<span>Ciprofloxacin<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp17').html('<span>Ciprofloxacin<br><i>Tunisia</i><br><strong>2 days</strong></span>');
            $('div.tp18').html('<span>Ciprofloxacin<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        }
            ...
            $('li.c15').delay(150).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c17').delay(180).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c18').delay(180).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c19').delay(190).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c20').delay(200).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");            

            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Cameroon</i>');
            $('li.c03').html('<i style="color:#000">Congo</i>');
            $('li.c04').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c05').html('<i style="color:#000">Ghana</i>');
            $('li.c06').html('<i style="color:#000">Kenya</i>');
            $('li.c07').html('<i style="color:#000">Mali</i>');
            $('li.c08').html('<i style="color:#000">Mauritius</i>');
            $('li.c09').html('<i style="color:#000">Morocco</i>');
            ...
            $('li.c14').html('<i style="color:#000">Tanzania</i>');
            $('li.c15').html('<i style="color:#000">Tunisia</i>');
            $('li.c16').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Co-trimoxazole<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Co-trimoxazole<br><i>Cameroon</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Co-trimoxazole<br><i>Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Co-trimoxazole<br><i>Democratic Republic of Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Co-trimoxazole<br><i>Ghana</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Co-trimoxazole<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Co-trimoxazole<br><i>Mali</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Co-trimoxazole<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Co-trimoxazole<br><i>Morocco</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Co-trimoxazole<br><i>Nigeria</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Co-trimoxazole<br><i>São Tomé and Príncipe</i><br><strong>2 days</strong></span>');
            $('div.tp12').html('<span>Co-trimoxazole<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp13').html('<span>Co-trimoxazole<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp14').html('<span>Co-trimoxazole<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp15').html('<span>Co-trimoxazole<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp16').html('<span>Co-trimoxazole<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        }
            ...
            $('li.c11').delay(110).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(160).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(160).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c15').delay(160).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c17').delay(170).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c18').delay(180).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c19').delay(190).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c04').html('<i style="color:#000">Ghana</i>');
            $('li.c05').html('<i style="color:#000">Kenya</i>');
            $('li.c06').html('<i style="color:#000">Nigeria</i>');
            $('li.c07').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c08').html('<i style="color:#000">South Africa, Gauteng Province</i>');
            $('li.c09').html('<i style="color:#000">Sudan</i>');
            $('li.c10').html('<i style="color:#000">Tanzania</i>');
            $('li.c11').html('<i style="color:#000">Tunisia</i>');
            $('li.c12').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Diazepam<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Diazepam<br><i>Burundi</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Diazepam<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Diazepam<br><i>Ghana</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Diazepam<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Diazepam<br><i>Nigeria</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Diazepam<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Diazepam<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Diazepam<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Diazepam<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Diazepam<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Diazepam<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        }
            ...
            $('li.c04').delay(40).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key30}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key5}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c03').html('<i>Congo</i>');
            $('li.c04').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c05').html('<i style="color:#000">Ethiopia</i>');
            $('li.c06').html('<i style="color:#000">Ghana</i>');
            $('li.c07').html('<i>Mali</i>');
            $('li.c08').html('<i style="color:#000">Mauritius</i>');
            ...
            $('div.tp01').html('<span>Diclofenac<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Diclofenac<br><i>Cameroon</i><br><strong>4 days</strong></span>');
            $('div.tp03').html('<span>Diclofenac<br><i>Congo</i><br><strong>2 days</strong></span>');
            $('div.tp04').html('<span>Diclofenac<br><i>Democratic Republic of Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Diclofenac<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Diclofenac<br><i>Ghana</i><br><strong>3 days</strong></span>');
            $('div.tp07').html('<span>Diclofenac<br><i>Mali</i><br><strong>2 days</strong></span>');
            $('div.tp08').html('<span>Diclofenac<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Diclofenac<br><i>São Tomé and Príncipe</i><br><strong>20 days</strong></span>');
            $('div.tp10').html('<span>Diclofenac<br><i>Sudan</i><br><strong>5 days</strong></span>');
            $('div.tp11').html('<span>Diclofenac<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Diclofenac<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        } 
            ...
            $('li.c03').delay(30).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c15').delay(150).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c17').delay(170).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c18').delay(180).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c19').delay(190).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c20').delay(200).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");            
            ...
            $('li.c06').html('<i style="color:#000">Egypt</i>');
            $('li.c07').html('<i style="color:#000">Ethiopia</i>');
            $('li.c08').html('<i style="color:#000">Ghana</i>');
            $('li.c09').html('<i style="color:#000">Kenya</i>');
            $('li.c10').html('<i style="color:#000">Mali</i>');
            $('li.c11').html('<i style="color:#000">Mauritius</i>');
            $('li.c12').html('<i style="color:#000">Morocco</i>');
            $('li.c13').html('<i style="color:#000">Nigeria</i>');
            $('li.c14').html('<i>São Tomé and Príncipe</i>');
            $('li.c15').html('<i style="color:#000">South Africa, Gauteng Province</i>');
            $('li.c16').html('<i style="color:#000">Sudan</i>');
            $('li.c17').html('<i style="color:#000">Tanzania</i>');
            $('li.c18').html('<i style="color:#000">Tunisia</i>');
            $('li.c19').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Glibenclamide<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Glibenclamide<br><i>Burundi</i><br><strong>1 day</strong></span>');
            $('div.tp03').html('<span>Glibenclamide<br><i>Cameroon</i><br><strong>6 days</strong></span>');
            $('div.tp04').html('<span>Glibenclamide<br><i>Congo</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Glibenclamide<br><i>Democratic Republic of Congo</i><br><strong>2 days</strong></span>');
            $('div.tp06').html('<span>Glibenclamide<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Glibenclamide<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Glibenclamide<br><i>Ghana</i><br><strong>1 day</strong></span>');
            $('div.tp09').html('<span>Glibenclamide<br><i>Kenya</i><br><strong>1 day</strong></span>');
            $('div.tp10').html('<span>Glibenclamide<br><i>Mali</i><br><strong>3 days</strong></span>');
            $('div.tp11').html('<span>Glibenclamide<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Glibenclamide<br><i>Morocco</i><br><strong>less than 1 day</strong></span>');
            $('div.tp13').html('<span>Glibenclamide<br><i>Nigeria</i><br><strong>3 days</strong></span>');
            $('div.tp14').html('<span>Glibenclamide<br><i>São Tomé and Príncipe</i><br><strong>6 days</strong></span>');
            $('div.tp15').html('<span>Glibenclamide<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp16').html('<span>Glibenclamide<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp17').html('<span>Glibenclamide<br><i>Tanzania</i><br><strong>1 day</strong></span>');
            $('div.tp18').html('<span>Glibenclamide<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp19').html('<span>Glibenclamide<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        } 
            ...
            $('li.c04').delay(40).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key10}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key10}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key30}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c15').delay(150).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c17').delay(170).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c18').delay(180).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c03').html('<i>Congo</i>');
            $('li.c04').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c05').html('<i style="color:#000">Egypt</i>');
            $('li.c06').html('<i>Ghana</i>');
            $('li.c07').html('<i style="color:#000">Kenya</i>');
            $('li.c08').html('<i style="color:#000">Mauritius</i>');
            $('li.c09').html('<i style="color:#000">Morocco</i>');
            $('li.c10').html('<i>Nigeria</i>');
            $('li.c11').html('<i>São Tomé and Príncipe</i>');
            ...
            $('div.tp01').html('<span>Omeprazole<br><i>Burkina Faso</i><br><strong>1 days</strong></span>');
            $('div.tp02').html('<span>Omeprazole<br><i>Burundi</i><br><strong>1 days</strong></span>');
            $('div.tp03').html('<span>Omeprazole<br><i>Congo</i><br><strong>13 days</strong></span>');
            $('div.tp04').html('<span>Omeprazole<br><i>Democratic Republic of Congo</i><br><strong>3 days</strong></span>');
            $('div.tp05').html('<span>Omeprazole<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Omeprazole<br><i>Ghana</i><br><strong>6 days</strong></span>');
            $('div.tp07').html('<span>Omeprazole<br><i>Kenya</i><br><strong>4 days</strong></span>');
            $('div.tp08').html('<span>Omeprazole<br><i>Mauritius</i><br><strong>1 day</strong></span>');
            $('div.tp09').html('<span>Omeprazole<br><i>Morocco</i><br><strong>2 days</strong></span>');
            $('div.tp10').html('<span>Omeprazole<br><i>Nigeria</i><br><strong>13 days</strong></span>');
            $('div.tp11').html('<span>Omeprazole<br><i>São Tomé and Príncipe</i><br><strong>41 days</strong></span>');
            $('div.tp12').html('<span>Omeprazole<br><i>South Africa, Gauteng Province</i><br><strong>2 days</strong></span>');
            $('div.tp13').html('<span>Omeprazole<br><i>Sudan</i><br><strong>3 days</strong></span>');
            $('div.tp14').html('<span>Omeprazole<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp15').html('<span>Omeprazole<br><i>Tunisia</i><br><strong>7 days</strong></span>');
            $('div.tp16').html('<span>Omeprazole<br><i>Uganda</i><br><strong>1 day</strong></span>');
        } 
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Ethiopia</i>');
            $('li.c03').html('<i style="color:#000">Mauritius</i>');
            $('li.c04').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c05').html('<i style="color:#000">Sudan</i>');

            $('div.tp01').html('<span>Paracetamol<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Paracetamol<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Paracetamol<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Paracetamol<br><i>São Tomé and Príncipe</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Paracetamol<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
        } 
            ...
            $('li.c03').delay(30).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key4}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c07').html('<i style="color:#000">Ghana</i>');
            $('li.c08').html('<i style="color:#000">Kenya</i>');
            $('li.c09').html('<i style="color:#000">Mali</i>');
            $('li.c10').html('<i style="color:#000">Mauritius</i>');
            $('li.c11').html('<i style="color:#000">Morocco</i>');
            $('li.c12').html('<i style="color:#000">South Africa, Gauteng Province</i>');
            $('li.c13').html('<i style="color:#000">Sudan</i>');
            $('li.c14').html('<i style="color:#000">Tanzania</i>');
            $('li.c15').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Salbutamol<br><i>Burkina Faso</i><br><strong>1 day</strong></span>');
            $('div.tp02').html('<span>Salbutamol<br><i>Burundi</i><br><strong>1 day</strong></span>');
            $('div.tp03').html('<span>Salbutamol<br><i>Cameroon</i><br><strong>3 days</strong></span>');
            $('div.tp04').html('<span>Salbutamol<br><i>Congo</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Salbutamol<br><i>Democratic Republic of Congo</i><br><strong>4 days</strong></span>');
            $('div.tp06').html('<span>Salbutamol<br><i>Egypt</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Salbutamol<br><i>Ghana</i><br><strong>5 days</strong></span>');
            $('div.tp08').html('<span>Salbutamol<br><i>Kenya</i><br><strong>2 days</strong></span>');
            $('div.tp09').html('<span>Salbutamol<br><i>Mali</i><br><strong>3 days</strong></span>');
            $('div.tp10').html('<span>Salbutamol<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Salbutamol<br><i>Morocco</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Salbutamol<br><i>South Africa, Gauteng Province</i><br><strong>less than 1 day</strong></span>');
            $('div.tp13').html('<span>Salbutamol<br><i>Sudan</i><br><strong>1 day</strong></span>');
            $('div.tp14').html('<span>Salbutamol<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp15').html('<span>Salbutamol<br><i>Uganda</i><br><strong>1 day</strong></span>'); 
    } 
            ...
            $('li.c04').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c05').html('<i style="color:#000">Sudan</i>');
            $('li.c06').html('<i style="color:#000">Tanzania</i>');

            $('div.tp01').html('<span>Salbutamol<br><i>Burkina Faso</i><br><strong>1 day</strong></span>');
            $('div.tp02').html('<span>Salbutamol<br><i>Egypt</i><br><strong>1 day</strong></span>');
            $('div.tp03').html('<span>Salbutamol<br><i>Mauritius</i><br><strong>3 days</strong></span>');
            $('div.tp04').html('<span>Salbutamol<br><i>São Tomé and Príncipe</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Salbutamol<br><i>Sudan</i><br><strong>4 days</strong></span>');
            $('div.tp06').html('<span>Salbutamol<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
    } 
    });
    $('#medicines_publ').on('change', function () {
         var key0 = '#A5A5A5';
         var key1 = '#c9b9a2';
         var key2 = '#93a76e';
         var key3 = '#5AFCBB';
        ...
        if (this.value == 'M01') {  
            ...
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(130).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Ethiopia</i>');
            $('li.c02').html('<i style="color:#000">Ghana</i>');
            $('li.c03').html('<i style="color:#000">Kenya</i>');
            $('li.c04').html('<i style="color:#000">Mauritius</i>');
            $('li.c05').html('<i style="color:#000">Morocco</i>');
            $('li.c06').html('<i style="color:#000">Nigeria</i>');
            $('li.c07').html('<i style="color:#000">Sudan</i>');
            $('li.c08').html('<i style="color:#000">Tanzania</i>');
            $('li.c09').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Amitriptyline<br><i>Ethiopia</i><br><strong>3 days</strong></span>');
            $('div.tp02').html('<span>Amitriptyline<br><i>Ghana</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Amitriptyline<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Amitriptyline<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp05').html('<span>Amitriptyline<br><i>Morocco</i><br><strong>free</strong></span>');
            $('div.tp06').html('<span>Amitriptyline<br><i>Nigeria</i><br><strong>2 days</strong></span>');
            $('div.tp07').html('<span>Amitriptyline<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Amitriptyline<br><i>Tanzania</i><br><strong>free</strong></span>');
            $('div.tp09').html('<span>Amitriptyline<br><i>Uganda</i><br><strong>free</strong></span>');
        } 
        else if (this.value == 'M02') {  
            animateGrid();configurate_M2();
            $('object.graphic').attr('data','svg/Amoxicillin.svg');
            ...
            $('div.tp01').html('<span>Amoxicillin<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Amoxicillin<br><i>Burundi</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Amoxicillin<br><i>Cameroon</i><br><strong>1 day</strong></span>');
            $('div.tp04').html('<span>Amoxicillin<br><i>Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Amoxicillin<br><i>Democratic Republic of Congo</i><br><strong>1 day</strong></span>');
            $('div.tp06').html('<span>Amoxicillin<br><i>Ethiopia</i><br><strong>1 day</strong></span>');
            $('div.tp07').html('<span>Amoxicillin<br><i>Mali</i><br><strong>2 days</strong></span>');
            $('div.tp08').html('<span>Amoxicillin<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp09').html('<span>Amoxicillin<br><i>Morocco</i><br><strong>free</strong></span>');
            $('div.tp10').html('<span>Amoxicillin<br><i>Nigeria</i><br><strong>1 day</strong></span>');
            $('div.tp11').html('<span>Amoxicillin<br><i>São Tomé and Príncipe</i><br><strong>1 day</strong></span>');
            $('div.tp12').html('<span>Amoxicillin<br><i>Sudan</i><br><strong>1 day</strong></span>');
            $('div.tp13').html('<span>Amoxicillin<br><i>Tunisia</i><br><strong>free</strong></span>');
        }
        else if (this.value == 'M03') {  
            animateGrid();configurate_M3();
            $('object.graphic').attr('data','svg/Atenolol.svg');
            ...
            $('li.c01').html('<i style="color:#000;">Ghana</i>');
            $('li.c02').html('<i style="color:#000;">Mauritius</i>');
            $('li.c03').html('<i style="color:#000;">Nigeria</i>');
            $('li.c04').html('<i style="color:#000;">São Tomé and Príncipe</i>');
            $('li.c05').html('<i style="color:#000;">Sudan</i>');
            $('li.c06').html('<i style="color:#000;">Tanzania</i>');
            $('li.c07').html('<i style="color:#000;">Tunisia</i>');

            $('div.tp01').html('<span>Atenolol<br><i>Ghana</i><br><strong>1 day</strong></span>');
            $('div.tp02').html('<span>Atenolol<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp03').html('<span>Atenolol<br><i>Nigeria</i><br><strong>1 day</strong></span>');
            $('div.tp04').html('<span>Atenolol<br><i>São Tomé and Príncipe</i><br><strong>1 day</strong></span>');
            $('div.tp05').html('<span>Atenolol<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Atenolol<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Atenolol<br><i>Tunisia</i><br><strong>free</strong></span>');
        }
        else if (this.value == 'M04') {  
            animateGrid();configurate_M4();
            $('object.graphic').attr('data','svg/Captopril.svg');
            ...
            $('li.c01').delay(0).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c02').delay(20).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Nigeria</i>');
            $('li.c03').html('<i>São Tomé and Príncipe</i>');
            $('li.c04').html('<i style="color:#000">Sudan</i>');
            $('li.c05').html('<i style="color:#000">Tanzania</i>');
            $('li.c06').html('<i style="color:#000">Tunisia</i>');

            $('div.tp01').html('<span>Captopril<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Captopril<br><i>Nigeria</i><br><strong>2 days</strong></span>');
            $('div.tp03').html('<span>Captopril<br><i>São Tomé and Príncipe</i><br><strong>1 day</strong></span>');
            $('div.tp04').html('<span>Captopril<br><i>Sudan</i><br><strong>3 days</strong></span>');
            $('div.tp05').html('<span>Captopril<br><i>Tanzania</i><br><strong>1 day</strong></span>');
            $('div.tp06').html('<span>Captopril<br><i>Tunisia</i><br><strong>free</strong></span>');
        }
        else if (this.value == 'M05') {  
            animateGrid();configurate_M5();
            $('object.graphic').attr('data','svg/Ceftriaxone.svg');
            ...
            $('li.c08').delay(80).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c10').delay(100).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c11').delay(110).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c12').delay(120).velocity({backgroundColor: key10}, { duration: 100 }, "easeOutSine");
            $('li.c13').delay(130).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c14').delay(140).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c15').delay(150).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c16').delay(160).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('div.tp01').html('<span>Ceftriaxone<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Ceftriaxone<br><i>Cameroon</i><br><strong>2 days</strong></span>');
            $('div.tp03').html('<span>Ceftriaxone<br><i>Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Ceftriaxone<br><i>Democratic Republic of Congo</i><br><strong>3 days</strong></span>');
            $('div.tp05').html('<span>Ceftriaxone<br><i>Ghana</i><br><strong>5 days</strong></span>');
            $('div.tp06').html('<span>Ceftriaxone<br><i>Kenya</i><br><strong>3 days</strong></span>');
            $('div.tp07').html('<span>Ceftriaxone<br><i>Mali</i><br><strong>2 days</strong></span>');
            $('div.tp08').html('<span>Ceftriaxone<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp09').html('<span>Ceftriaxone<br><i>Morocco</i><br><strong>free</strong></span>');
            $('div.tp10').html('<span>Ceftriaxone<br><i>Nigeria</i><br><strong>6 days</strong></span>');
            $('div.tp11').html('<span>Ceftriaxone<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Ceftriaxone<br><i>Sudan</i><br><strong>13 days</strong></span>');
            $('div.tp13').html('<span>Ceftriaxone<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp14').html('<span>Ceftriaxone<br><i>Tunisia</i><br><strong>free</strong></span>');
            $('div.tp15').html('<span>Ceftriaxone<br><i>Uganda</i><br><strong>free</strong></span>');
        } 
        else if (this.value == 'M06') {  
            animateGrid();configurate_M6();
            $('object.graphic').attr('data','svg/Ciprofloxacin.svg');
            ...
            $('li.c11').html('<i style="color:#000">Morocco</i>');
            $('li.c12').html('<i style="color:#000">Nigeria</i>');
            $('li.c13').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c15').html('<i style="color:#000">Sudan</i>');
            $('li.c16').html('<i style="color:#000">Tanzania</i>');
            $('li.c17').html('<i style="color:#000">Tunisia</i>');
            $('li.c18').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Ciprofloxacin<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Ciprofloxacin<br><i>Burundi</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Ciprofloxacin<br><i>Cameroon</i><br><strong>1 day</strong></span>');
            $('div.tp04').html('<span>Ciprofloxacin<br><i>Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Ciprofloxacin<br><i>Democratic Republic of Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Ciprofloxacin<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Ciprofloxacin<br><i>Ghana</i><br><strong>3 days</strong></span>');
            $('div.tp08').html('<span>Ciprofloxacin<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Ciprofloxacin<br><i>Mali</i><br><strong>4 days</strong></span>');
            $('div.tp10').html('<span>Ciprofloxacin<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp11').html('<span>Ciprofloxacin<br><i>Morocco</i><br><strong>free</strong></span>');
            $('div.tp12').html('<span>Ciprofloxacin<br><i>Nigeria</i><br><strong>4 days</strong></span>');
            $('div.tp13').html('<span>Ciprofloxacin<br><i>São Tomé and Príncipe</i><br><strong>1 day</strong></span>');
            $('div.tp15').html('<span>Ciprofloxacin<br><i>Sudan</i><br><strong>1 day</strong></span>');
            $('div.tp16').html('<span>Ciprofloxacin<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp17').html('<span>Ciprofloxacin<br><i>Tunisia</i><br><strong>free</strong></span>');
            $('div.tp18').html('<span>Ciprofloxacin<br><i>Uganda</i><br><strong>free</strong></span>');
        }
        else if (this.value == 'M07') {  
            animateGrid();configurate_M7();
            $('object.graphic').attr('data','svg/Co-trimoxazole.svg');
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Cameroon</i>');
            $('li.c03').html('<i style="color:#000">Chad</i>');
            $('li.c04').html('<i style="color:#000">Congo</i>');
            $('li.c05').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c06').html('<i style="color:#000">Ghana</i>');
            $('li.c07').html('<i style="color:#000">Kenya</i>');
            $('li.c08').html('<i style="color:#000">Mali</i>');
            $('li.c09').html('<i style="color:#000">Mauritius</i>');
            $('li.c10').html('<i style="color:#000">Morocco</i>');
            $('li.c11').html('<i style="color:#000">Nigeria</i>');
            $('li.c12').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c13').html('<i style="color:#000">Sudan</i>');
            $('li.c14').html('<i style="color:#000">Tanzania</i>');
            $('li.c15').html('<i style="color:#000">Tunisia</i>');
            $('li.c16').html('<i style="color:#000">Uganda</i>');
            ...
            $('div.tp01').html('<span>Co-trimoxazole<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Co-trimoxazole<br><i>Cameroon</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Co-trimoxazole<br><i>Chad</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Co-trimoxazole<br><i>Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Co-trimoxazole<br><i>Democratic Republic of Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Co-trimoxazole<br><i>Ghana</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Co-trimoxazole<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Co-trimoxazole<br><i>Mali</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Co-trimoxazole<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp10').html('<span>Co-trimoxazole<br><i>Morocco</i><br><strong>free</strong></span>');
            $('div.tp11').html('<span>Co-trimoxazole<br><i>Nigeria</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Co-trimoxazole<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp13').html('<span>Co-trimoxazole<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp14').html('<span>Co-trimoxazole<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp15').html('<span>Co-trimoxazole<br><i>Tunisia</i><br><strong>free</strong></span>');
            $('div.tp16').html('<span>Co-trimoxazole<br><i>Uganda</i><br><strong>free</strong></span>');
        }
        else if (this.value == 'M08') {  
            animateGrid();configurate_M8();
            $('object.graphic').attr('data','svg/Diazepam.svg');
            ...
            $('li.c04').html('<i style="color:#000">Ghana</i>');
            $('li.c05').html('<i style="color:#000">Kenya</i>');
            $('li.c06').html('<i style="color:#000">Mauritus</i>');
            $('li.c07').html('<i style="color:#000">Nigeria</i>');
            $('li.c08').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c09').html('<i style="color:#000">Sudan</i>');
            $('li.c10').html('<i style="color:#000">Tanzania</i>');
            $('li.c11').html('<i style="color:#000">Tunisia</i>');
            $('li.c12').html('<i style="color:#000">Uganda</i>');
            ...
            $('div.tp01').html('<span>Diazepam<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Diazepam<br><i>Cameroon</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Diazepam<br><i>Cameroon</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Diazepam<br><i>Ghana</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Diazepam<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Diazepam<br><i>Mauritus</i><br><strong>free</strong></span>');
            $('div.tp07').html('<span>Diazepam<br><i>Nigeria</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Diazepam<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Diazepam<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Diazepam<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Diazepam<br><i>Tunisia</i><br><strong>free</strong></span>');
            $('div.tp12').html('<span>Diazepam<br><i>Uganda</i><br><strong>free</strong></span>');
        }
        else if (this.value == 'M09') {  
            animateGrid();configurate_M9();
            $('object.graphic').attr('data','svg/Diclofenac.svg');
            ...
            $('li.c03').delay(30).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key3}, { duration: 100 }, "easeOutSine");
            $('li.c06').delay(60).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c07').delay(70).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c08').delay(80).velocity({backgroundColor: key5}, { duration: 100 }, "easeOutSine");
            $('li.c09').delay(90).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Congo</i>');
            $('li.c03').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c04').html('<i style="color:#000">Ethiopia</i>');
            $('li.c05').html('<i style="color:#000">Ghana</i>');
            $('li.c06').html('<i style="color:#000">Mali</i>');
            $('li.c07').html('<i style="color:#000">Mauritius</i>');
            $('li.c08').html('<i style="color:#000">Sudan</i>');
            $('li.c09').html('<i style="color:#000">Tanzania</i>');
            $('li.c10').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Diclofenac<br><i>Burkina Faso</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Diclofenac<br><i>Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Diclofenac<br><i>Democratic Republic of Congo</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Diclofenac<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Diclofenac<br><i>Ghana</i><br><strong>3 days</strong></span>');
            $('div.tp06').html('<span>Diclofenac<br><i>Mali</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Diclofenac<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp08').html('<span>Diclofenac<br><i>Sudan</i><br><strong>5 days</strong></span>');
            $('div.tp09').html('<span>Diclofenac<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Diclofenac<br><i>Uganda</i><br><strong>free</strong></span>');
        } 
        else if (this.value == 'M10') {  
            animateGrid();configurate_M10();
            $('object.graphic').attr('data','svg/Glibenclamide.svg');
            ...
            $('li.c01').html('<i style="color:#000">Cameroon</i>');
            $('li.c02').html('<i style="color:#000">Chad</i>');
            $('li.c03').html('<i style="color:#000">Democratic Republic of Congo</i>');
            $('li.c04').html('<i style="color:#000">Ethiopia</i>');
            $('li.c05').html('<i style="color:#000">Ghana</i>');
            $('li.c06').html('<i style="color:#000">Kenya</i>');
            $('li.c07').html('<i style="color:#000">Mauritius</i>');
            $('li.c08').html('<i style="color:#000">Morocco</i>');
            $('li.c09').html('<i style="color:#000">Nigeria</i>');
            $('li.c10').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c11').html('<i style="color:#000">Sudan</i>');
            $('li.c12').html('<i style="color:#000">Tanzania</i>');
            $('li.c13').html('<i style="color:#000">Tunisia</i>');
            $('li.c14').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Glibenclamide<br><i>Cameroon</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Glibenclamide<br><i>Chad</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Glibenclamide<br><i>Democratic Republic of Congo</i><br><strong>2 days</strong></span>');
            $('div.tp04').html('<span>Glibenclamide<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Glibenclamide<br><i>Ghana</i><br><strong>1 day</strong></span>');
            $('div.tp06').html('<span>Glibenclamide<br><i>Kenya</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Glibenclamide<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Glibenclamide<br><i>Morocco</i><br><strong>less than 1 day</strong></span>');
            $('div.tp09').html('<span>Glibenclamide<br><i>Nigeria</i><br><strong>3 days</strong></span>');
            $('div.tp10').html('<span>Glibenclamide<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Glibenclamide<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
            $('div.tp12').html('<span>Glibenclamide<br><i>Tanzania</i><br><strong>1 day</strong></span>');
            $('div.tp13').html('<span>Glibenclamide<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp14').html('<span>Glibenclamide<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        } 
        else if (this.value == 'M11') {  
            animateGrid();configurate_M11();
            $('object.graphic').attr('data','svg/Omeprazole.svg');
            ...
            $('li.c01').delay(0).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c02').delay(20).velocity({backgroundColor: key6}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c04').delay(40).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            $('li.c05').delay(50).velocity({backgroundColor: key1}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Burundi</i>');
            $('li.c02').html('<i style="color:#000">Ghana</i>');
            $('li.c03').html('<i style="color:#000">Kenya</i>');
            $('li.c04').html('<i style="color:#000">Mauritius</i>');
            $('li.c05').html('<i style="color:#000">Morocco</i>');
            ...
            $('li.c08').html('<i style="color:#000">Sudan</i>');
            $('li.c09').html('<i style="color:#000">Tanzania</i>');
            $('li.c10').html('<i style="color:#000">Tunisia</i>');
            $('li.c11').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Omeprazole<br><i>Burundi</i><br><strong>less than 1 day</strong></span>');
            $('div.tp02').html('<span>Omeprazole<br><i>Ghana</i><br><strong>6 days</strong></span>');
            $('div.tp03').html('<span>Omeprazole<br><i>Kenya</i><br><strong>1 day</strong></span>');
            $('div.tp04').html('<span>Omeprazole<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Omeprazole<br><i>Morocco</i><br><strong>less than 1 day</strong></span>');
            $('div.tp06').html('<span>Omeprazole<br><i>Nigeria</i><br><strong>8 days</strong></span>');
            $('div.tp07').html('<span>Omeprazole<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp08').html('<span>Omeprazole<br><i>Sudan</i><br><strong>2 days</strong></span>');
            $('div.tp09').html('<span>Omeprazole<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp10').html('<span>Omeprazole<br><i>Tunisia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp11').html('<span>Omeprazole<br><i>Uganda</i><br><strong>less than 1 day</strong></span>');
        } 
        else if (this.value == 'M12') {  
            animateGrid();configurate_M12();
            $('object.graphic').attr('data','svg/Paracetamol.svg');
            ...
            $('div.tp02').html('<span>Paracetamol<br><i>Ethiopia</i><br><strong>less than 1 day</strong></span>');
            $('div.tp03').html('<span>Paracetamol<br><i>Mauritius</i><br><strong>less than 1 day</strong></span>');
            $('div.tp04').html('<span>Paracetamol<br><i>São Tomé and Príncipe</i><br><strong>less than 1 day</strong></span>');
            $('div.tp05').html('<span>Paracetamol<br><i>Sudan</i><br><strong>less than 1 day</strong></span>');
        } 
        else if (this.value == 'M13') {  
            animateGrid();configurate_M13();
            ...
            $('li.c01').html('<i style="color:#000">Burkina Faso</i>');
            $('li.c02').html('<i style="color:#000">Mauritius</i>');
            $('li.c03').html('<i style="color:#000">Morocco</i>');
            $('li.c04').html('<i style="color:#000">São Tomé and Príncipe</i>');
            $('li.c05').html('<i style="color:#000">Sudan</i>');
            $('li.c06').html('<i style="color:#000">Tanzania</i>');
            $('li.c07').html('<i style="color:#000">Tunisia</i>');
            $('li.c08').html('<i style="color:#000">Uganda</i>');

            $('div.tp01').html('<span>Salbutamol<br><i>Burkina Faso</i><br><strong>1 day</strong></span>');
            $('div.tp02').html('<span>Salbutamol<br><i>Mauritius</i><br><strong>free</strong></span>');
            $('div.tp03').html('<span>Salbutamol<br><i>Morocco</i><br><strong>free</strong></span>');
            $('div.tp04').html('<span>Salbutamol<br><i>São Tomé and Príncipe</i><br><strong>2 days</strong></span>');
            $('div.tp05').html('<span>Salbutamol<br><i>Sudan</i><br><strong>2 day</strong></span>');
            $('div.tp06').html('<span>Salbutamol<br><i>Tanzania</i><br><strong>less than 1 day</strong></span>');
            $('div.tp07').html('<span>Salbutamol<br><i>Tunisia</i><br><strong>free</strong></span>');
            $('div.tp08').html('<span>Salbutamol<br><i>Uganda</i><br><strong>free</strong></span>');
    } 
        else if (this.value == 'M14') {  
            animateGrid();configurate_M14();
            $('object.graphic').attr('data','svg/Simvastatin.svg');
            ...
            $('li.c01').delay(0).velocity({backgroundColor: key2}, { duration: 100 }, "easeOutSine");
            $('li.c02').delay(20).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            $('li.c03').delay(30).velocity({opacity: '0', scale: '0.1'}, { duration: 100 }, "easeOutSine");
            ...
            $('li.c01').html('<i style="color:#000">Sudan</i>');

            $('div.tp01').html('<span>Salbutamol<br><i>Sudan</i><br><strong>2 days</strong></span>');
    } 
    });
});
...
$('#switch').click(function(){
    $('#medicines_priv, #medicines_publ').toggle().val('0');
    initialize();animateGrid()
    $('li.c01').html('');
    $('li.c02').html('');
    $('li.c03').html('');
    $('li.c04').html('');
    ...
    if($('#medicines_priv').css('display') == 'none'){ 
        $('#detail_ck p').text('').append('In order to purchase one of these 14 medicines <b>under the public sanitary system,</b> you would need to work between one and 20 days.');
    } else {
        $('#detail_ck p').text('').append('In order to purchase one of these 14 medicines <b>under the private sanitary system,</b> you would need to work between one and 30 days.');
    }
});
...
function initialize(){
    ...
    $('.set01 li').delay(0).velocity({backgroundColor: key0}, { duration: 100 }, "easeOutSine");
    $('.set02 li').delay(0).velocity({backgroundColor: key0}, { duration: 100 }, "easeOutSine");
    $('.set03 li').delay(0).velocity({backgroundColor: key0}, { duration: 100 }, "easeOutSine");
    $('.set04 li').delay(0).velocity({backgroundColor: key0}, { duration: 100 }, "easeOutSine");
